    ...
    def update(
        ...
        for track in tracks:
            ...
            if state == "flash_green":
                ...
                color     = self.color_registry.get_color(pid)
                thickness = 3
            ...
            # For returning persons, draw an inner rectangle to simulate a
            # "dashed" look, making it visually distinct from new persons.
